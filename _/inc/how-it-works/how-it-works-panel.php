...
<div id="slide<?php echo $process_counter; ?>" class="slide-outer<?php echo ($process_counter == 0) ? ' active':''; ?>">
	<div class="step<?php echo ($panel['hiw_col']) ? ' col-'.$panel['hiw_col'] : ''; ?>">
		
		<?php if ($process_counter > 0) { ?>
		<a href="#slide<?php echo ($process_counter - 1); ?>" class="nav-link back-link"><i class="fa fa-arrow-circle-up fa-lg"></i></a>
		<?php } ?>
