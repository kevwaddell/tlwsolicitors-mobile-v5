<div id="start" class="step animated">
	<div class="icon"><i class="fa fa-exclamation-circle fa-2x"></i></div>
...
<div id="slide1" class="step animated">
	<div class="icon"><i class="fa fa-building-o fa-2x"></i></div>
...
<div id="slide5" class="step">
	<div class="icon"><i class="fa fa-thumbs-down fa-2x"></i></div>
	<a href="#slide2" class="back-link"><i class="fa fa-arrow-circle-up fa-lg"></i></a>
...
<div id="slide8" class="step">
	<div class="icon"><i class="fa fa-group fa-2x"></i></div>
	<a href="#start" class="back-link"><i class="fa fa-arrow-circle-up fa-lg"></i></a>
    <p class="header">Good or bad</p>
